...
class Formation_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		function formation_social_scripts() {
			wp_enqueue_style( 'formation-social-css',  plugin_dir_url( __FILE__ ) . 'css/formation-social-widget.css' );
		}
		...
		function formation_social_admin_scripts() {
			wp_enqueue_style( 'formation-social-css',   plugin_dir_url( __FILE__ ) . 'css/formation-social-widget.css' );	
			wp_register_script('formation-social-admin-js',  plugin_dir_url( __FILE__ ) . 'js/formation-social-widget.js', array('jquery'));
